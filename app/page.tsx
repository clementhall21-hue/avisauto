...
const TONE_RESPONSES: Record<string, { court: string; normal: string; developpe: string; signature: string }> = {
  Professionnel: {
    court: "Merci Laurent pour votre retour. Nous prenons note de votre remarque concernant le bruit et mettons tout en œuvre pour y remédier. Nous espérons vous accueillir à nouveau dans de meilleures conditions.",
    normal: "Merci Laurent pour ce retour constructif. Nous sommes sincèrement désolés que le bruit en soirée ait perturbé votre repos — c'est un point sur lequel nous travaillons activement. Votre confort est notre priorité absolue et nous prenons chaque remarque de ce type très au sérieux. Des actions concrètes sont en cours pour améliorer l'isolation de nos chambres. Nous espérons avoir l'occasion de vous accueillir à nouveau.",
    developpe: "Merci Laurent pour ce retour constructif. Nous sommes sincèrement désolés que le bruit en soirée ait perturbé votre repos — c'est un point sur lequel nous travaillons activement. Votre confort est notre priorité absolue et nous prenons chaque remarque de ce type très au sérieux. Des actions concrètes sont en cours pour améliorer l'isolation de nos chambres. Nous espérons avoir l'occasion de vous accueillir à nouveau et de vous offrir l'expérience que vous méritez. Nous restons à votre entière disposition pour tout échange complémentaire, et vous remercions sincèrement de nous avoir accordé ce moment de confiance.",
    signature: "Cordialement, Sophie — Directrice de l'Hôtel Le Clos",
  },
  Chaleureux: {
    court: "Merci Laurent pour ce retour ! 😊 On est vraiment navrés pour le bruit en soirée et on travaille à améliorer ça. On espère vous revoir très bientôt dans de meilleures conditions !",
    normal: "Merci beaucoup Laurent pour votre retour ! 😊 On est vraiment navrés pour ce bruit en soirée — c'est loin de l'expérience qu'on souhaite offrir à nos clients. On prend votre remarque très à cœur et on travaille activement à améliorer ça. Malgré ce point, on est vraiment contents que l'ensemble du séjour se soit bien passé. On espère de tout cœur vous revoir bientôt ! 🙏",
    developpe: "Merci beaucoup Laurent pour votre retour ! 😊 On est vraiment navrés pour ce bruit en soirée — c'est loin de l'expérience qu'on souhaite offrir à nos clients. On prend votre remarque très à cœur et on travaille activement à améliorer ça. Malgré ce point, on est vraiment contents que l'ensemble du séjour se soit bien passé. On espère de tout cœur vous revoir bientôt pour vous offrir le séjour que vous méritez ! 🙏 N'hésitez pas à nous contacter directement avant votre prochain séjour — ce sera un vrai plaisir de tout mettre en place pour que ce soit parfait !",
    signature: "À très vite, Sophie & toute l'équipe 💙",
  },
  Empathique: {
    court: "Merci Laurent d'avoir partagé votre ressenti. Nous comprenons que le bruit ait affecté votre confort et nous en sommes sincèrement désolés. Votre expérience méritait mieux.",
    normal: "Merci Laurent d'avoir pris le temps de partager votre ressenti avec nous. Nous comprenons pleinement que le bruit en soirée ait pu affecter la qualité de votre repos, et nous en sommes sincèrement désolés — votre confort méritait bien mieux. Votre retour est précieux et nous prenons cette situation très au sérieux. Nous travaillons à trouver une solution durable pour que cela ne se reproduise plus.",
    developpe: "Merci Laurent d'avoir pris le temps de partager votre ressenti avec nous. Nous comprenons pleinement que le bruit en soirée ait pu affecter la qualité de votre repos, et nous en sommes sincèrement désolés — votre confort méritait bien mieux. Votre retour est précieux et nous prenons cette situation très au sérieux. Nous travaillons à trouver une solution durable pour que cela ne se reproduise plus. Sachez que vos retours, même difficiles, nous touchent profondément et nous rappellent pourquoi nous faisons ce métier. Merci de nous accorder votre confiance malgré tout.",
    signature: "Avec toute notre considération, Sophie — L'Hôtel Le Clos",
  },
  Décontracté: {
    court: "Merci Laurent ! Pour le bruit en soirée, on t'entend et on bosse dessus. On espère te revoir bientôt avec un séjour bien plus calme ! 👌",
    normal: "Merci Laurent ! Content que le séjour se soit globalement bien passé. Pour le bruit en soirée, on t'entend complètement — c'est pas du tout ce qu'on veut pour nos clients et on bosse dessus sérieusement. Ton retour nous aide vraiment à nous améliorer, donc merci pour ça. À bientôt, et cette fois ce sera beaucoup plus calme, promis ! 👌",
    developpe: "Merci Laurent ! Content que le séjour se soit globalement bien passé. Pour le bruit en soirée, on t'entend complètement — c'est pas du tout ce qu'on veut pour nos clients et on bosse dessus sérieusement. Ton retour nous aide vraiment à nous améliorer, donc merci pour ça. Vraiment, c'est grâce à des gens comme toi qu'on progresse. À bientôt, et cette fois ce sera au top du top, garanti ! 🔥🙌",
...
const FEATURES = [
  ...
  { icon: '✍️', title: 'Signature personnalisée', desc: "Définissez le nom sous lequel l'IA signe chaque réponse — votre prénom, le nom de l'établissement, ou tout autre signature qui vous ressemble.", color: 'rgba(6,182,212,0.15)' },
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex md:hidden items-center gap-2">
            ...
            <button
              ...
              style={{ fontSize: '0.72rem', padding: '5px 11px', borderRadius: '0', background: '#6d28d9', color: '#fff', border: 'none', cursor: 'pointer', fontWeight: 700, whiteSpace: 'nowrap' }}
            >
              Essai gratuit
            </button>
          </div>
